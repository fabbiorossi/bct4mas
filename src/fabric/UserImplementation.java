 ...
 */
public class UserImplementation implements User, Serializable {
  private static final long serializationId = 1L;
  private static final long serialVersionUID = -8392573892256024912L;
  ...
  UserImplementation(String name, String affiliation, String mspId, Enrollment enrollment) {
    this.name = name;
  ...
  @Override public String getAffiliation() {
    return affiliation;
  }
  ...
  @Override public String getMspId() {
    return mspId;
  }
