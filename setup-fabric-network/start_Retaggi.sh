...
# Copy channel channel.blocks from peer0 to peer1 and peer 2, then peer1 and peer2 can join the channels
rm -rf ~/.temp/*
...
# Join peer1.org1.example.com and peer2.org1.example.com to the channel servicech
...
# Join peer1.org1.example.com and peer2.org1.example.com to the channel transch
